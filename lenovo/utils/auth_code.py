...
from djangoBegin import settings  # 项目中的settings文件，配置了BASEDIR路径，在这里无需关注
...
def get_authcode_img(request):
    ...
    font_path = os.path.join(settings.BASE_DIR,"lenovo","static","font","cerepf.ttf")  # 获取字体，注意有些字体无法显示数字
